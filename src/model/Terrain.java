 ...
 */
public class Terrain extends GameObject implements LevelControl {
    ...
    /** Method that represents level up mechanism in the game.
     * 
     * vz adding by GameUtil's LEVEL_MOVE_MULTIPLAYER attribute and
     * multiply by GameUtil's getInstance() method and getCurrentLevel() method
     * 
     */
    @Override
    public void levelUp() {
    ...
    /** Method that represents restart level mechanism in the game.
     * 
     * vz equal with GameUtil's V_TERRAIN_MOVE attribute
     * 
     */
    @Override
